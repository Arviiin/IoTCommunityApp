...
import com.archer.model.UserBean;
...
public class RegisterActivity extends Activity{
    ...
    private void init() {
        ...
        this.communication = (Spinner) this.findViewById(R.id.regi_communication_way);
    ...
    private class RegisterListener implements View.OnClickListener {
         ...
         * @return UserBean 包含有用户完整注册信息的User包装�?
         */
        private UserBean getUser() {
            UserBean userBean = new UserBean();
            userBean.setPassword(password.getText().toString());
            userBean.setUsername(userName.getText().toString());
            userBean.setSex(mySex);
            userBean.setCommunication(myCommunication);
            userBean.setCommunication(communication_content.getText().toString());
            return userBean;
        }
    }
